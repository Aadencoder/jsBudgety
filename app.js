...
var budgetController = (function() {
	...
	return {
		addItem: function(type, des, val) {
			...
			//create new item based on inc or enp
			if (type === 'exp') {
...
var UIController = (function() {
	...
	var DOMstrings = {
	 ...
	 var formatNumber =  function(num, type) {
		...
		// + or - // .00 decimal points // proper , formating
		num = Math.abs(num);
		num = num.toFixed(2);
	...
	return {
		...
		displayBudget: function(obj) {
			...
			document.querySelector(DOMstrings.budgetLabel).textContent = 'Rs: ' + formatBudget(obj.budget) + '/-';
...
var controller = (function(budgetCtrl, UICtrl) {
	...
	var ctrlDeleteItem = function(event) {
		...
		if (itemID) {
			...
			//3. Update adnd show the new budget
			updateBudget();
